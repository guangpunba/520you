...
<header class="am-topbar admin-header">
  ...
  <div class="am-collapse am-topbar-collapse" id="topbar-collapse">
    ...
    <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
      <li><a href="javascript:;"><?php echo ($cmd); ?>您好：<?php echo (session('username')); ?></a></li>
  ...
  <div class="admin-content">
      <div class="am-g">
          <div class="am-u-sm-12">
            <h2 class="am-text-default am-margin-top"><span class="am-icon-file-text-o"></span> 新闻列表</h2>
      ...
      <div class="am-g am-margin-bottom">
        <div class="am-u-sm-3">
          <a href="<?php echo U('News/addNew');?>" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 添加新闻</a>
        </div>
      
        
        <div class="am-u-sm-4 pl0">
          <div class="am-input-group">
              <input type="text" class="am-form-field" name='keyword' placeholder='请输入您要搜索的标题'>
      ...
      <div class="am-g">
          <div class="am-u-sm-12">
              ...
              <div id="loading" style=' text-align: center; '><img src="/520you/Public/Admin/dist/images/loading.gif"></div>
          </div>
      </div>
