...
<header class="am-topbar admin-header">
  ...
  <div class="am-collapse am-topbar-collapse" id="topbar-collapse">
    ...
    <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
      ...
      <li><a href="javascript:;"><span class="am-icon-envelope-o"></span> 收件箱 <span class="am-badge am-badge-warning" id='msgCounts'>0</span></a></li>
  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
        <h2 class="am-text-default am-margin-top"><span class="am-icon-envelope"></span> 消息管理 -- 添加消息</h2>
    ...
    <div class="am-g">
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-6">
            ...
            <form class="am-form am-form-horizontal" id="form">
                ...
                <div class="am-form-group">
                    <label for="username" class="am-u-sm-3 am-form-label">推送对象：</label>
                    <div class="am-u-sm-9">
                        <select data-am-selected="{btnWidth: '120px',}" name='pushobj' id="pushobj" placeholder='请选择'>
                            <option selected value=""></option>
                            <?php if(is_array($group)): $i = 0; $__LIST__ = $group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["groupid"]); ?>" ><?php echo ($vo["groupname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>

                    </div>
                </div>
                <div class="am-form-group">
                    <label for="repwd" class="am-u-sm-3 am-form-label">消息详情：</label>
                    <div class="am-u-sm-9">
                      <!-- 加载编辑器的容器 -->
                ...
                <div class="am-form-group">
                    <div class="am-u-sm-9 am-u-sm-offset-3">
                      <button type="submit" class="am-btn am-btn-primary am-disabled" id="submitAdd" data-am-loading="{loadingText: '提交中...'}">提交</button>
                    </div>
                </div>
            </form>
...
<script type="text/javascript" data-main='/520you/Public/Admin/dist/js/AdminsMsg-main.js' src="/520you/Public/Admin/dist/js/libs/require.js"></script>
