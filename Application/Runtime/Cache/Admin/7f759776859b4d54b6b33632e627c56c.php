      ...
      <ul class="am-list admin-sidebar-list">
		...
		<li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="nav-msg">
          	<?php if($_SESSION['groupid']== 1 ): ?><li><a href="<?php echo U('AdminsMsg/index');?>" class="am-cf"><span class="am-icon-envelope"></span> 管理员消息推送</a></li>
           
            	<li><a href="admin-help.html"><span class="am-icon-envelope-o"></span> 会员消息推送</a></li><?php endif; ?>
          </ul>
        </li>
      </ul>
  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
        <h2 class="am-text-default am-margin-top"><span class="am-icon-user"></span> 用户管理 -- 添加账号</h2>
                ...
                <div class="am-form-group">
                  ...
                  <div class="am-u-sm-9">
                      <select name='groupid' id="group">
                          <?php if(is_array($groupname)): $i = 0; $__LIST__ = $groupname;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["groupid"]); ?>"><?php echo ($vo["groupname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                      </select>
