            ...
            <form class="am-form am-form-horizontal" id="form">
                ...
                <div class="am-form-group">
                  ...
                  <div class="am-u-sm-4 am-u-end">
                      <select data-am-selected="{btnWidth: '120px',}" name='type' id="type" placeholder='请选择'>
                          <option selected value=""></option>
                          <?php if(is_array($newstype)): $i = 0; $__LIST__ = $newstype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                      </select>
                  </div>
                </div>
