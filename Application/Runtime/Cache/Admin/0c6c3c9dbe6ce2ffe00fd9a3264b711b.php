  ...
  <div class="admin-content">
      <div class="am-g">
          <div class="am-u-sm-12">
            <h2 class="am-text-default am-margin-top"><span class="am-icon-envelope"></span> 管理员消息推送</h2>
      ...
      <?php if($_SESSION['groupid']== 1 ): ?><div class="am-g am-margin-bottom">
        <div class="am-u-sm-12">
          <a href="<?php echo U('AdminsMsg/addMsg');?>" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 添加消息</a>
        </div>
      </div><?php endif; ?>
      ...
      <div class="am-g">
          <div class="am-u-sm-12">
              <table class="am-table am-table-bd am-table-striped admin-content-table">
                  <thead>
                      <tr>
                        <th>序号<?php echo ($time); ?></th><th>标题</th><th>发送时间</th><th>推送人</th>
                        <?php if($_SESSION['groupid']== 1 ): ?><th>推送对象</th><?php endif; ?>
                      </tr>
                  </thead>
                  <tbody>
                      <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr data-id='<?php echo ($vo["id"]); ?>'>
                        <td><?php echo ($k); ?></td>
                        <td>
                          <?php if($vo["read"] == 1): ?><span class="am-icon-envelope am-text-warning"></span><?php endif; ?>
                          <a href="<?php echo U('AdminsMsg/details',array('mid' => $vo['mid']));?>" class="am-btn-link"><?php echo ($vo["title"]); ?></a>
                        </td>
                        <td><?php echo (date("Y-m-d H:i:s",$vo["createtime"])); ?></td>
                        <td><a href="#"><?php echo ($vo["createby"]); ?></a></td> 
                        <?php if($_SESSION['groupid']== 1 ): ?><td><a href="#"><?php echo ($vo["groupname"]); ?></a></td><?php endif; ?>
